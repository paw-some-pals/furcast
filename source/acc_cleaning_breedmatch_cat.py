...
import re
import numpy as np
from data_utils import categorize_color, categorize_breed_by_species, categorize_size,get_seasons,check_colour, categorize_color_cat
...
def main():
    ...
    final_df_aac_dogs = final_austin_cat_df["color"].apply(categorize_color_cat)
