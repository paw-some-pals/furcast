"""
Step 1 of 2: Hyperparameter sweep for AAC cat models.
...
Saves best params to models/aac_best_params_cat.json.
Run run_final_training_aac_cat.py after this to train on all data and save models.
"""
...
def main():
    ...
    print("Now run run_final_training_aac_cat.py to train on all data and save models.")
