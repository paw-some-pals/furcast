...
Assumes cleanadoptionsbybreedanddatelongterm.py has already been run and datasets/ABDLT_output_cat.csv exists.

Trains a Random Forest for both:
  - outcome_type (classification)
  - time_in_shelter (regression)

Saves trained models to models/ABDLT_outcome_type_cat.pkl and models/ABDLT_time_in_shelter_cat.pkl.
"""
...
CLEANED_DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "datasets", "ABDLT_output_cat_merge.csv")
...
def main():
    ...
    save_model(model_clf, "ABDLT_outcome_type_cat_merged.pkl")
    ...
    save_model(model_reg, "ABDLT_time_in_shelter_cat_merged.pkl")
