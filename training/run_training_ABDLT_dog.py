...
CLEANED_DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "datasets", "ABDLT_output_dog_merge.csv")
...
def main():
    ...
    save_model(model_clf, "ABDLT_outcome_type_dog_merge.pkl")
    ...
    save_model(model_reg, "ABDLT_time_in_shelter_dog_merge.pkl")
