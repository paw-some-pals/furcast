...
CLEANED_DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "datasets", "ABDLT_output_dog_matched.csv")
...
def main():
    ...
    save_model(model_clf, "ABDLT_outcome_type_dog.pkl")
    ...
    save_model(model_reg, "ABDLT_time_in_shelter_dog.pkl")
