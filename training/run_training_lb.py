...
CLEANED_DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "datasets", "long_beach_long_term.csv")
...
def main():
    print("=== Loading AAC cleaned data ===")
    ...
    save_model(model_clf, "lb_long_outcome_type.pkl")
    ...
    save_model(model_reg, "lb_long_time.pkl")
