...
Assumes cleanadoptionsbybreedanddate.py has already been run and datasets/shorttermABD.csv exists.
...
CLEANED_DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "datasets", "shorttermABD.csv")
...
def main():
    ...
    save_model(model_clf, "shorttermABD.pkl")
    ...
    save_model(model_reg, "shorttermabdmodel.pkl")
